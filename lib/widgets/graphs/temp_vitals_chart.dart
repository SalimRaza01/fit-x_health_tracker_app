...
class TempVitalsChart extends StatefulWidget {
  const TempVitalsChart({super.key});

  @override
  State<StatefulWidget> createState() => TempVitalsChartState();
}

class TempVitalsChartState extends State<TempVitalsChart> {
  @override
