...
class StressLevelChart extends StatefulWidget {
  const StressLevelChart({super.key});

  @override
  State<StatefulWidget> createState() => StressLevelChartState();
}

class StressLevelChartState extends State<StressLevelChart> {
