...
class TimeStatsGraph extends StatefulWidget {
  const TimeStatsGraph({super.key});
  @override
  State<TimeStatsGraph> createState() => _TimeStatsGraphState();
}
class _TimeStatsGraphState extends State<TimeStatsGraph> {
  String selectedRange = 'This Week';
  final Color activeColor = const Color.fromARGB(255, 3, 209, 240);
