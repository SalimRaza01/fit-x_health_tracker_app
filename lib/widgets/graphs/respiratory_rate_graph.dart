...
class RespiratoryRateGraph extends StatefulWidget {
  const RespiratoryRateGraph({super.key});

  @override
  State<RespiratoryRateGraph> createState() => _RespiratoryRateGraphState();
}

class _RespiratoryRateGraphState extends State<RespiratoryRateGraph> {
