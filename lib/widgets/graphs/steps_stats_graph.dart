...
class StepsStatsGraph extends StatefulWidget {
  const StepsStatsGraph({super.key});
  @override
  State<StepsStatsGraph> createState() => _StepsStatsGraphState();
}
class _StepsStatsGraphState extends State<StepsStatsGraph> {
  String selectedRange = 'This Week';
  final Color activeColor = const Color(0xFFD3C200);
